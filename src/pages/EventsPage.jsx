  ...
  return (
    <div className="flex items-center gap-3 mb-6">
      ...
      <div>
        ...
        {count !== undefined && (
          <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">{count} event{count !== 1 ? 's' : ''}</p>
        )}
      </div>
    </div>
  );
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 pt-12 pb-8">
          <div className="max-w-2xl mb-8">
            <span className="section-label mb-2 block">
              <CalendarDays className="w-3.5 h-3.5" /> What's on
            </span>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-base">
              Stay in the loop with everything happening around you
            </p>
          </div>
