...
export const seedClubs = [
  ...
  },
  {
    ...
    contactEmail: 'creditcircle@campushub.edu',
    memberCount: 95,
    foundedYear: 2024,
    socialLinks: { instagram: 'https://instagram.com' },
  ...
  },
  {
    ...
    contactEmail: 'rotaract@campushub.edu',
    memberCount: 150,
    foundedYear: 2025,
    socialLinks: { instagram: 'https://instagram.com' },
  ...
  },
  {
    ...
    banner: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=900&auto=format&fit=crop',
    tags: ['Photography', 'Cinematography', 'Filmmaking', 'Editing', 'Acting', 'Creative Media'],
    facultyCoordinator: 'Lakshmikant Sir',
    contactEmail: '4thwall@campushub.edu',
    memberCount: 75,
    foundedYear: 2026,
    socialLinks: { instagram: 'https://instagram.com' },
